...
class VideoPlayView(LoginRequiredMixin, View):
    ...
    def get(self, request, video_id):
        ...
        if not user_courses:
            ...
            user_course.save()
        user_cousres = UserCourse.objects.filter(course=course)
        user_ids = [user_cousre.user.id for user_cousre in user_cousres]
...
class CourseCommentView(LoginRequiredMixin,View):
    def get(self,request,course_id):
        ...
        all_user_courses =UserCourse.objects.filter(user_id__in=user_ids)
        courses_ids = [user_courses.course.id for user_course in user_courses]
